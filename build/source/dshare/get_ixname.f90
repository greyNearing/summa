...
contains
 ...
 select case(trim(varName))
  ...
  case('albSatNIR'                ); get_ixparam = iLookPARAM%albSatNIR              ! saturated soil abledo in near infrared spectrum 
  case('albDryVis'                ); get_ixparam = iLookPARAM%albDryVis              ! dry soil abledo in visible spectrum
  case('albDryNIR'                ); get_ixparam = iLookPARAM%albDryNIR              ! saturated soil abledo in near infrared spectrum
